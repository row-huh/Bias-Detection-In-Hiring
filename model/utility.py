...
def pdf_to_text(path):
    ...
    try:
        ...
        # the error occurs because the values are returned before
        # the users upload files, this usually doesnt affect the functionality
        # however to avoid error showing up on the app, handling it  here
        pass